    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{ url('jobs') }}" method="post" target="_blank">
          ...
          <div class="mb-3">
            <label for="exampleInputUsername1" class="form-label">Client Name</label>
            <input type="text" name="client_name" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Client Name">
          </div>
          <div class="mb-3">
            <label for="exampleInputUsername1" class="form-label">Client Position</label>
